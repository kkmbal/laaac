...
<div id="contents">
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%" class="gridt_input">
		...
		<tr>
			<th class="left">제목</th>
			<td class="left"><input name="" type="text" class="input" style="width:870px;" value="기존 제목"></td>
		</tr>
		<tr>
		...
		<tr>
			<td class="center" colspan="2"><textarea name="" class="textarea" style="width:960px; height:250px;">기존 내용</textarea></td>
		</tr>
		<tr>
			...
			<td class="left">
				...
				<table cellpadding="0" cellspacing="0" border="0" class="gridt_file">
					<tr>
						...
						<td class="gridt_blank" nowrap></td>
						<td class="filel"><a href="#">파일명.ppt</a></td>
					</tr>
				</table>
				<!-- gridt_file - end -->
			</td>
	...
	<div class="btn_form">
		...
		<div class="main"><input type="button" class="btnm" value="수정" onclick="" /><input type="button" class="btnm_cancel" value="목록" onclick="location.href='customer_list.html'" /></div>
		<div class="cb"></div>
	</div>
