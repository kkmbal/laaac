		...
		<ul>
			<li>
				...
				<div class="search_set">
					<ul>
						<li class="photo"><a href="#"><img src="${ctx}/images/test/photo1_250_01.jpg" class="photo"></a></li>
						<li class="title">
							...
							<div class="gauge">
								...
								<table cellspacing="0" cellpadding="0" border="0">
									<tr>
										...
										<td width="151" height="20" align="center" valign="middle"><img src="${ctx}/images/test/ct_gauge_st04.gif" align="absmiddle"></td>
										<td><input type="button" class="btni_good03" title="좋아요" onclick="" /></td>
									</tr>
								</table>
								<!-- chart_gauge03 - end -->
							</div>
							<div class="scrap"><a href="#">11378</a>&nbsp;<a href="#"><img src="${ctx}/images/icon/i_scrap.gif" align="absmiddle"></a></div>
						</li>
					</ul>
				</div>
				<!-- search_set01 - end -->
			...
			<li>
				...
				<div class="search_set">
					<ul>
						<li class="photo"><a href="#"><img src="${ctx}/images/test/photo1_250_02.jpg" class="photo"></a></li>
						<li class="title">
						...
						<li class="chart">
							...
							<div class="scrap"><a href="#">1278</a>&nbsp;<a href="#"><img src="${ctx}/images/icon/i_scrap.gif" align="absmiddle"></a></div>
						</li>
					</ul>
				</div>
				<!-- search_set02 - end -->
			...
			<li>
				...
				<div class="search_set">
					<ul>
						<li class="photo"><a href="#"><img src="${ctx}/images/test/photo1_250_03.jpg" class="photo"></a></li>
						<li class="title">
						...
						<li class="chart">
							...
							<div class="scrap"><a href="#">978</a>&nbsp;<a href="#"><img src="${ctx}/images/icon/i_scrap.gif" align="absmiddle"></a></div>
						</li>
					</ul>
				</div>
				<!-- search_set03 - end -->
			...
			<li>
				...
				<div class="search_set">
					<ul>
						<li class="photo"><a href="#"><img src="${ctx}/images/test/photo1_250_04.jpg" class="photo"></a></li>
						<li class="title">
						...
						<li class="chart">
							...
							<div class="scrap"><a href="#">52</a>&nbsp;<a href="#"><img src="${ctx}/images/icon/i_scrap.gif" align="absmiddle"></a></div>
						</li>
					</ul>
				</div>
				<!-- search_set04 - end -->
			...
			<li>
				...
				<div class="search_set">
					<ul>
						<li class="photo"><a href="#"><img src="${ctx}/images/test/photo1_250_05.jpg" class="photo"></a></li>
						<li class="title">
						...
						<li class="chart">
							...
							<div class="scrap"><a href="#">8</a>&nbsp;<a href="#"><img src="${ctx}/images/icon/i_scrap.gif" align="absmiddle"></a></div>
						</li>
					</ul>
				</div>
				<!-- search_set05 - end -->
