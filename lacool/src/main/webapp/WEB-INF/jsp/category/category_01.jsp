...
<div id="contents">
	...
	<div class="contents_layout">
		<div class="fl" style="width:700px;">
			...
			<div class="cate_view"><a href="#"><img src="${ctx}/resources/images/test/photo2_700_01.jpg" class="photo"></a></div>
		...
		<div class="fl" style="width:290px;">
			...
			<div class="cate_list">
				<ul>
					<li>
						<!-- 01 start -->
						<div class="photo fl"><a href="#"><img src="${ctx}/resources/images/test/photo2_700_01.jpg" class="photo"></a></div>
						<div class="txt fl"><a href="#">던킨도너츠 3+3 이벤트!!<br>매주 수요일 5일,12일,19일</a></div>
						<!-- 01 end -->
					</li>
					<li>
						<!-- 02 start -->
						<div class="photo fl"><a href="#"><img src="${ctx}/resources/images/test/photo2_700_02.jpg" class="photo"></a></div>
						<div class="txt fl"><a href="#">2014 대구국제섬유<br>박람회 프리뷰 인 대구</a></div>
						<!-- 02 end -->
					</li>
					<li>
						<!-- 03 start -->
						<div class="photo fl"><a href="#"><img src="${ctx}/resources/images/test/photo2_700_03.jpg" class="photo"></a></div>
						<div class="txt fl"><a href="#">제주도, 산책길 새섬<br>가파도, 마라도, 비양도...</a></div>
						<!-- 03 end -->
					</li>
					<li>
						<!-- 04 start -->
						<div class="photo fl"><a href="#"><img src="${ctx}/resources/images/test/photo2_700_04.jpg" class="photo"></a></div>
						<div class="txt fl"><a href="#">2014 대구국제섬유<br>박람회 프리뷰 인 대구</a></div>
						<!-- 04 end -->
					</li>
					<li>
						<!-- 05 start -->
						<div class="photo fl"><a href="#"><img src="${ctx}/resources/images/test/photo2_700_05.jpg" class="photo"></a></div>
						<div class="txt fl"><a href="#">던킨도너츠 3+3 이벤트!!<br>매주 수요일 5일,12일,19일</a></div>
						<!-- 05 end -->
					</li>
					<li>
						<!-- 06 start -->
						<div class="photo fl"><a href="#"><img src="${ctx}/resources/images/test/photo2_700_06.jpg" class="photo"></a></div>
